...
Description: Here we deal with node failures by delibrately taking dow the 2nd router and then make the other routers realize it 
by keeping track of a timer.
...
b)Complete: partially: The proxy makes the 2nd router go down and logs that its down. The first router gets to know this and times out
and logs it. 
